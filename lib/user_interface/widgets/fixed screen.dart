...
class _MainScreenState extends State<MainScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    appBar:new AppBar(
    backgroundColor: Color(0xff27AC9B),
    actions: [new Image.asset("images/2.png"),SizedBox(width:20.0,)]
    ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  Widget creatIcon (IconData icon){return IconButton( icon: Icon(icon,size:40,color: Color(0xff27AC9B),),);}
///////////////////////////////
  int currentIndex=2;
  final pages=[ Setting(),IsFavorite(), Add(),Profile(),Home()];
